...
use vpkmerge_core::{
    ...
    live_hero_entries, live_hero_materials, merge, model_draw_call_targets, model_uv_segments,
    model_vertex_targets, split, AnimOptions, CollisionPolicy, GeometryEdit, MergeOptions,
    ModelPartSelector, OverlapPolicy, PathPredicate, PortraitInfo, PoseSelection, SegmentBy,
    SoulGlow, SoulImportCloneOptions, SoulOrient, SoundEvents, SplitOptions, SplitOutput,
};
